  ...
  \IfFileExists{\asy@asyfile}{%
    ...
    \asy@If\asy@process{%
      ...
      \pdf@system{%
        ...
        \unexpanded{"\RequirePackage{asyprocess}\ProcessAsy}
...
\end{lstlisting}
Simply change |pdflatex| to |latex| to have \EPS\ graphics produced by Asymptote. Note that it is \emph{mandatory} to use the |-comp| suffix for the jobname.  Of course, the same preamble tweaking discussed for |\asyProcessPreamble| can apply here as well.
