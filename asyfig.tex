...
But before the graphic can be inserted it must be processed (in the future I might make this an automatic option within the package).  The processing is performed by the \pkg{asyprocess} package in an auxiliary \LaTeX\ execution. Here is the shell script that I use to do this:
\begin{lstlisting}
#!/bin/sh
